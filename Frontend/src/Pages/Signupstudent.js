      ...
      >
        ...
        >
          <div className="lgnd1" style={{ height: "97vh", width: "70%" }}>
            ...
            >
              <select
                ...
                style={{
                  ...
                  height: 40,
                  border:
                    (validation === true) & (skills.length < 1)
                      ? "1px solid red"
                      : "1px solid grey",
                }}
              >
            ...
            >
              {skills.map((i) => (
                <label style={{ marginLeft: 10 }}>{i},</label>
              ))}
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                ...
                <option>
                  To obtain Data Analytics and Problem-Solving abilities
                </option>
