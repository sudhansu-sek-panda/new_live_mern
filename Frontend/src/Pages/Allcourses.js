...
function Allcourses() {
  ...
  const getRequestData1 = () => {
    axios.get(baseUrl + "request").then((res) => {
      setRequestList1(
        res.data.data.filter((i) => (i.to === stdId) & (i.status === "accept"))
      );
    });
  };
        ...
        >
          ...
          >
            <h4
              ...
              style={{ right: 10, position: "absolute", top: 5 }}
            >
            ...
            >
              ...
              <div className="lgnd1" style={{ height: 40, width: "70%" }}>
                <label>Email :</label>{" "}
                <label style={{ fontWeight: "bold" }}>{data.email}</label>
              </div>
              <div className="lgnd1" style={{ height: 40, width: "70%" }}>
                <label>Knowledge Level :</label>{" "}
                <label style={{ fontWeight: "bold" }}>{data.grade}</label>
              </div>
              <div className="lgnd1" style={{ height: 40, width: "70%" }}>
                <label>Learning Objective :</label>{" "}
                <label style={{ fontWeight: "bold" }}>{data.language}</label>
              </div>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    >
                      <button
                        onClick={() => {
                          setTParseData(
                            studentList.filter((i) => i._id === j.to)[0]
                          );
                          setNoti1(true);
                        }}
                        style={{
            ...
            >
              ...
              {type === "admin" ? (
                ...
                >
                  ...
                  {teacherList
                    .filter((i) => i.skills.includes(teacherSpec))
                      ...
                      >
                        ...
                        >
                          ...
                          <label style={{ fontSize: 12 }}>
                            at {tParshtime.map((i) => timeConvert(i.from))} to{" "}
                            {tParshtime.map((i) => timeConvert(i.to))}
                          </label>
                        </div>
                        <div
                          style={{
